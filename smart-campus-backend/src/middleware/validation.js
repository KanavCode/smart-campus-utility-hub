...
const validationSchemas = {
  ...
  updateSettings: Joi.object({
    ...
    current_semester: Joi.string().valid('Fall', 'Spring', 'Summer', 'Odd', 'Even').required(),
  ...
  // UUID primary key parameter (events, clubs, electives, users in Supabase schema)
  uuidParam: Joi.object({
    id: Joi.string().uuid().required()
  }),

  // Integer primary key parameter (kept for backward compatibility)
  idParam: Joi.object({
