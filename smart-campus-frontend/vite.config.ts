...
// import { componentTagger } from "lovable-tagger"; // Lovable.dev platform plugin — not needed for local dev
...
export default defineConfig(({ mode }) => ({
  ...
  plugins: [react()], // componentTagger() removed for local dev (requires Lovable.dev platform)
  resolve: {
    alias: {
